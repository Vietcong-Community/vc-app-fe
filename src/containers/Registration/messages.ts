...
export const messages = defineMessages({
  ...
  surnameLabel: {
    id: 'app.containers.Registration.RegistrationForm.surnameLabel',
  ...
  emailLabel: {
    id: 'app.containers.Registration.RegistrationForm.emailLabel',
    defaultMessage: 'Email',
  },
  passwordLabel: {
    id: 'app.containers.Registration.RegistrationForm.passwordLabel',
