...
export const messages = defineMessages({
  title: {
    id: 'app.containers.Mcrvc.title',
    defaultMessage: 'MČRVC',
  },
  description: {
    id: 'app.containers.Mcrvc.description',
    defaultMessage:
  ...
  moreInfo: {
    id: 'app.containers.Mcrvc.moreInfo',
    defaultMessage: 'Pro více informací sledujte FB stránku: ',
  },
  spring: {
    id: 'app.containers.Mcrvc.spring',
    defaultMessage: 'Jarní termín',
  },
  autumn: {
    id: 'app.containers.Mcrvc.autumn',
